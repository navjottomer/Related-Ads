...
?>
<h2 class="render-title "><?php _e('Related Ads Preferences', 'related'); ?></h2>
...
<div class="form-horizontal">
        ...
        <label for="ra_numads" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Number of related ads  ', 'related'); ?></label>:
        </div>
         
        <div class="form-controls"><input type="text" name="ra_numads" id="ra_numads" value="<?php echo $ra_numads; ?>" />
        <div class="help-box"><?php _e('Enter how many ads you want to show on Item Page (Default is 4)', 'related'); ?></div>
       </div>
        </div>
        
        <div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="picOnly" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Show ads with pictures only','related'); ?></label>:
        </div>
        ...
        <div class="help-box"><?php _e('Select Yes if you want to show ads with picture only', 'related'); ?></div>
        </div></div>
        </div>
       
       	<div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="ra_category" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Show ads with same category','related'); ?></label>:
        </div>
        <div class="form-controls"><div class="form-label-selection">
        <select name="ra_category" id="ra_category">
        	<option <?php if($category ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'related'); ?></option>
        	<option <?php if($category ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'related'); ?></option>
        </select>
        <div class="help-box"><?php _e('Select Yes to Filter ads by Category', 'related'); ?></div>
        </div></div>
        </div>
       
       	<div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="ra_country" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Show ads with same country','related'); ?></label>:
        </div>
        <div class="form-controls"><div class="form-label-selection">
        <select name="ra_country" id="ra_country">
        	<option <?php if($country ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'related'); ?></option>
        	<option <?php if($country ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'related'); ?></option>
        </select>
        <div class="help-box"><?php _e('Select Yes to Filter ads by Country', 'related'); ?></div>
        </div></div>
        </div>
        
        <div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="ra_region" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Show ads with same region','related'); ?></label>:
        </div>
        <div class="form-controls"><div class="form-label-selection">
        <select name="ra_region" id="ra_region">
        	<option <?php if($region ==0){echo 'selected="selected"';}?> value='0'><?php _e('No', 'related'); ?></option>
        	<option <?php if($region ==1){echo 'selected="selected"';}?> value='1'><?php _e('Yes', 'related'); ?></option>
        </select>
        <div class="help-box"><?php _e('Select Yes to Filter ads by Region', 'related'); ?></div>
        </div></div>
        </div>
        
        <div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="css" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Disable default Css ','related'); ?></label>:
        </div>
        <div class="form-controls"><div class="form-label-selection">
        ...
        <div class="form-row"><div class="form-label wide" style="width:400px;border-bottom:1px solid grey;">
        <label for="autoembed" style="font-weight: bold;float:left;margin-left:40px;"><?php _e('Related Ads AutoEmbed ','related'); ?></label>:
        </div>
        <div class="form-controls"><div class="form-label-selection">
        <select name="autoembed" id="autoembed">
        	<option <?php if($autoembed ==0){echo 'selected="selected"';}?> value='0'><?php _e('Disable', 'related'); ?></option>
        	<option <?php if($autoembed ==1){echo 'selected="selected"';}?> value='1'><?php _e('Enable', 'related'); ?></option>
        </select>
        <div class="help-box"><?php _e('Choose Enable to Autoembed related ads in your Item page', 'related'); ?></div>
        <div class="help-box"><?php _e('If you disable this feature than copy this function to your Item Page', 'related'); ?>
        ...
        <input type="submit" value="<?php _e('Save Related Ads Settings', 'related'); ?>" class="btn btn-submit" style="margin-left:150px; padding:7px 40px;"/>
